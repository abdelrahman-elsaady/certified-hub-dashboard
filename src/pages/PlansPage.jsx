            ...
            <div key={plan._id} className="bg-white rounded-xl border border-gray-200 p-6">
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex gap-1.5">
                  ...
                  {plan.isTrial && (
                    <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-amber-50 text-amber-700">Trial</span>
                  )}
                  <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-gray-600 mb-1">Trial Duration (days, 0 = none)</label>
                  <input
                    type="number"
                ...
                <div className="flex items-end pb-1">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label className="text-sm text-gray-700">Is Trial Plan</label>
                  </div>
                </div>
              </div>
              ...
              {form.isTrial && !editingPlan && existingTrial[form.targetAudience] && (
                <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg">
                  <p className="text-sm text-amber-700">
                    ⚠️ A trial plan for <strong>{form.targetAudience}</strong> already exists ({existingTrial[form.targetAudience].name?.en}). 
                    Only one trial plan per audience is allowed.
                  </p>
                </div>
              )}
